				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" href="#atn">
							<h5><i class="fas fa-rss-square"> </i> Attaindence</h5>
						</a>
					</h4>
				</div>
					...
					<ul class="list-group">
						<li class="list-group-item mylist-group-item">
							<a href="Attaindance.php">
								<h5><i class="fa fa-check"></i> Mark</h5>
							</a>
						</li>
						<li class="list-group-item mylist-group-item">
							<h5><i class="fa fa-book"></i> Report</h5>
						</li>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" href="#test">
							<h5><i class="fas fa-rss-square"> </i> Manage News Feed</h5>
						</a>
					</h4>
				</div>
				<div id="test" class="panel-collapse collapse">
					<ul class="list-group">
						<li class="list-group-item mylist-group-item">
							<a href="Addpost.php">
								<h5><i class="fas fa-file"></i> All Post</h5>
							</a>
						</li>
						<li class="list-group-item mylist-group-item">
							<a href="Addpost.php">
								<h5><i class="fas fa-plus-square"></i> Add Post</h5>
							</a>
						</li>
						<!--
                        <li class="list-group-item mylist-group-item">
...
-->
						...
						<li class="list-group-item mylist-group-item">
							<a href="users.php">
								<h5><i class="fas fa-users"></i> Categories</h5>
							</a>
						</li>
					</ul>
				</div>
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" href="#fal">
							<h5><i class="fas fa-user"> </i> Manage Faculty</h5>
						</a>
					</h4>
				</div>
...
-->
						<li class="list-group-item mylist-group-item">
							<a href="Add-Teacher.php">
								<h5><i class="fa fa-user-plus"></i> Add & Assign</h5>
							</a>
						</li>
						<!--
                        <li class="list-group-item mylist-group-item">
                            <h5><i class="fa fa-briefcase"></i> Delete</h5>
                        </li>
-->
					</ul>
				</div>
					...
					<ul class="list-group">
						<li class="list-group-item mylist-group-item">
							<a href="Add-Subject.php">
								<h5><i class="fas fa-book"></i> Add</h5>
							</a>
						</li>
