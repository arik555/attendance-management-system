<div id="mySidenav" class="sidenav mt-0">
        <ul class="list-group active">
            <li class=" active list-group-item d-flex justify-content-between align-items-center">
                ...
                <div class="container ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <h5>Welcome <?php echo $_SESSION['sname']; ?> | <span>Student</span></h5>
                        </div>
            ...
            <li class="  list-group-item d-flex justify-content-between align-items-center">
                <a href="Attaindance.php"><i class="fas fa-clipboard"></i> My Attendance Reports</a>
                <span class="badge badge-primary badge-pill">12</span>
            </li>
            ...
            <li class="  list-group-item d-flex justify-content-between align-items-center">
                <a href="Addpost.php"><i class="fas fa-rss-square"></i> Blog</a>
                <span class="badge badge-primary badge-pill">12</span>
            </li>
